                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                @if($cari_tahun == null)
                                <h5>Laporan Berkala Pendapatan Tahun {{$year}}</h5>
                                @endif

                                @if($cari_tahun != null)
                                 <h5>Laporan Berkala Pendapatan Tahun {{$cari_tahun}}</h5>
                                @endif
                            </div>

                            <div class="card-block">
                             <div class="col-lg-10">
                                <form action="{{route('kepala_desa-laporan_berkala_pendapatan')}}" method="GET">
                                  <div class="row">
                                    <div class="col-lg-3">
                                      <div class="form-row">
...
<script type="text/javascript">
    Highcharts.chart('chartPedapatan', {
        chart: {
            type: 'column'
        },
        title: {
