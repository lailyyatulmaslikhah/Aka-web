                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Data Guide</h5>
                                <button type="button" style="float: right;" class="btn btn-success right"  data-toggle="modal" data-target="#ModalTambahGuide" >
                                    Tambah Guide
                                </button>
                            </div>
                                ...
                                <table id="dataTable" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          <td>{{ $no++ }}</td>
                                          <td>
                                            <img src="{{asset('uploads/foto_pengelola/'.$guide->photo)}}" width="100px" height="100px" style="border-radius: 0%;">
                                        </td>
                                        <td>{{$guide->name}}</td>
                                        <td>{{$guide->email}}</td>
                                        <td>{{$guide->alamat}}</td>
...
<!-- Modal -->
<div class="modal fade" id="ModalTambahGuide" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
